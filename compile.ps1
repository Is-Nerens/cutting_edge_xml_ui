...
clang -std=c99 main.c "lib\nanoVG\nanovg.c" -I"$glewInclude" -I"$sdlInclude" -I"$SDL_ttf_Include" -I"$nanovgInclude" -L"$glewLib" -L"$sdlLib" -L"$SDL_ttf_Lib" -lglew32 -lSDL3 -lSDL3_ttf -lopengl32 -lgdi32 -o nano_app.exe -Wno-deprecated-declarations
